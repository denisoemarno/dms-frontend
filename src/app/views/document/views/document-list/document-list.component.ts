...
export class DocumentListComponent implements OnInit {
  ...
  onPopulate(
    ...
    this.Documentervice.getDocument(q, offset, limit).subscribe((res) => {
  ...
  onUpdate(e) {
    ...
    if (this.dataSelected) {
      this.router.navigate(['/documents/edit'], {
        relativeTo: this.activatedRoute,
        state: { data: this.dataSelected, mode: 'update', source : 'list'},
      });
    } else {
  ...
  onView(e) {
    ...
    if (this.dataSelected) {
      this.router.navigate(['/documents/show'], {
        relativeTo: this.activatedRoute,
        state: { data: this.dataSelected, mode: 'view', source : 'list' },
      });
    } else {
      this.confirmationService.confirm({
        acceptIcon: null,
