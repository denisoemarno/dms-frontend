...
@Component({
  selector: 'app-document-me-task',
  templateUrl: './document-me-task.component.html',
  styleUrls: ['./document-me-task.component.scss']
})
export class DocumentMeTaskComponent implements OnInit {
  ...
  onPopulate(
    ...
    this.Documentervice.getmytask(q, offset, limit).subscribe((res) => {
  ...
  onUpdate(e) {
    ...
    if (this.dataSelected) {
      this.router.navigate(['/documents/edit'], {
        relativeTo: this.activatedRoute,
        state: { data: this.dataSelected, mode: 'update', source : 'my-list' },
      });
    } else {
  ...
  onView(e) {
    ...
    if (this.dataSelected) {
      this.router.navigate(['/documents/show'], {
        relativeTo: this.activatedRoute,
        state: { data: this.dataSelected, mode: 'view', source : 'my-list' },
      });
    } else {
      this.confirmationService.confirm({
        acceptIcon: null,
